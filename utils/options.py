...
class Options:
	...
	def initialize(self):
		...
		self.parser.add_argument('--src_img_dir', default="datasets/TrueScale", type=str, help='Folder of source image')
		self.parser.add_argument('--src_latent_dir', default="test_images/src_F", type=str, help='Folder of source latent')
		self.parser.add_argument('--ref_img_dir', default="datasets/TrueScale", type=str, help='Folder of reference image')
